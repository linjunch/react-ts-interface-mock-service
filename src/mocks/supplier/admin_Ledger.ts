...
export default {
  'GET /api/supplier/admin/ledgers': ledgerList,
  'GET /api/supplier/admin/ledger/:ledgerToken/detail': ledgerDetail,
  'GET /api/supplier/admin/ledger/:ledgerToken/goodses': ledgerGoodsList,
  'GET /api/supplier/admin/ledger/:ledgerToken/goods/:ledgerItemToken/shs': ledgerShList,
};
