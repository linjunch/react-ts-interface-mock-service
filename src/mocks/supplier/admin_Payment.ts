...
export default {
  'GET /api/supplier/admin/payments': paymentList,
  'GET /api/supplier/admin/payment/:paymentToken/detail': paymentDetail,
  'GET /api/supplier/admin/payment/:paymentToken/items': paymentItemList,
};
